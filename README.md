...
> ⚠️ **v0.16.0 — Phases 00–16 complete + Phase 17 partial (209/241 lessons).** **Phases fully implemented:** 00 Setup (8/8), 01 Number Theory (18/18), 02 Abstract Algebra (14/14), 03 Elliptic Curves (12/12), 04 Lattices (12/12), 05 Probability & Information (10/10), 06 Coding Theory (8/8), 07 Symmetric Crypto (14/14), 08 Classical Asymmetric (14/14), 09 Hashes/Commitments/Accumulators (8/8), 10 Protocols (12/12), 11 ZK Foundations (12/12), 12 ZK Proof Systems (16/16), 13 ZK Engineering (12/12), 14 PQ Lattice (14/14), 15 PQ Code/Hash/Multivariate (10/10), 16 PQ Isogenies & Migration (9/9). **Partial:** 17 FHE & MPC (6/12). **Scaffolded (stubs):** 18 Applied Blockchain & Identity (0/10), 19 Cryptanalysis & Side-Channels (0/10), 20 Capstones (0/6). Contributions welcome — see [`CONTRIBUTING.md`](CONTRIBUTING.md).
